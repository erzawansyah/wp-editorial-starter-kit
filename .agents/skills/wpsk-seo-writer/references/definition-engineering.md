# Definition Engineering for Indonesian GEO & AI Citations

Generative Engine Optimization (GEO) governs whether AI models (Google AI Overview, Perplexity, Claude, ChatGPT) extract and quote your content.

---

## 1. The Indonesian Definition Sentence Formula

Derived from top-cited glossary resources, the primary definition sentence must follow this precise structure:

```text
[Term] adalah [Category Noun] yang [Verb 1], [Verb 2], dan [Verb 3] untuk [Specific Purpose] — [Differentiating Clause].
```
...
- **Dana Darurat:**
  > "Dana darurat adalah alokasi simpanan likuid yang dihimpun, dipisahkan dari rekening harian, dan dicadangkan khusus untuk mengantisipasi pengeluaran mendadak tanpa mengganggu stabilitas keuangan jangka panjang."

---

## 2. The 5-Element Definition Paragraph

A definition sentence earns the AI citation. The entire definition paragraph convinces the human reader.
